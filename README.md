[![Go Actions Status](https://github.com/baharclerode/gnostic/workflows/Go/badge.svg)](https://github.com/baharclerode/gnostic/actions)
...
[baharclerode/gnostic-grpc](https://github.com/baharclerode/gnostic-grpc) contains a
...
[baharclerode/gnostic-go-generator](https://github.com/baharclerode/gnostic-go-generator)
...
1.  Get this package by downloading it with `git clone`.
        ...
        git clone https://github.com/baharclerode/gnostic
        cd gnostic
...
6.  You can also compile files that you specify with a URL. Here's another way
    ...
    This is mainly for use in testing and debugging.
            ...
            gnostic --text-out=petstore.text https://raw.githubusercontent.com/baharclerode/gnostic/master/examples/v2.0/json/petstore.json
...
8.  **gnostic** also supports plugins. **gnostic**'s plugin interface is
    ...
    [gnostic-grpc](https://github.com/baharclerode/gnostic-grpc) and
    [gnostic-go-generator](https://github.com/baharclerode/gnostic-go-generator),
